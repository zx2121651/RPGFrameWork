...
目前内置的常用数据结构体包括道具、任务和技能三种。添加后可以直接在系统中使用。<br>
框架也支持用户自己定义结构数据体，详情请见 <a href="DOCUMENTATION.md">DOCUMENTATION.md</a>。<br>
...
采用支持键盘和鼠标的多层级窗口UI，在父窗口选择分类后可进入子窗口。修改窗口尺寸时采用职责链，传递请求给顶层窗口以改变尺寸。<br>
